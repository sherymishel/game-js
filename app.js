...
const colors = ['#ffcfe6', '#c9ffda','#fbffb0', '#8affc6', '#e2c9ff','#8ae2ff', '#ffdbc9', '#caffc9'];
...
function finishGame() {
  ...
  toMainBtn.classList.add('time-btn');
  toMainBtn.classList.add('back-btn');
  toMainBtn.innerHTML = `Играть снова`;
  board.append(toMainBtn);
